...
<div class="panel panel-default">
    ...
    <table width="100%">
        <tr>
            <td width="25%">Kode</td>
            <td>:</td>
            <td><input type="text" name="kode" id="kode" class="form-control" value="<?php echo $head['kode']; ?>" required readonly></td>
        </tr>
        <tr>
            <td width="25%">Nama</td>
            <td>:</td>
            <td><input type="text" name="nama" id="nama" class="form-control" value="<?php echo $head['nama']; ?>" required onchange="sama()" ></td>
        </tr>
        <tr>
            <td>Jenis</td>
            <td>:</td>
            <td><select name="jenis" class="form-control" id="jenis" required onchange="sama()">
                    ...
                    foreach($jenis->result() as $j)
                    {
                        ...
                        if (!(strcmp($j->kd_jenis, htmlentities($head['jenis'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";}
    ...
    <table width="100%">
        <tr>
            ...
            <td>:</td>
            <td>
                <input type="text" name="kode" id="kode2" value="<?php echo $head['kode']; ?>" required readonly hidden>
        ...
        <tr>
            <td width="25%"></td>
            <td></td>
            <td><input type="text" name="nama" id="nama2" value="<?php echo $head['nama']; ?>" required readonly hidden>
...
<table border="1" class="table table-striped table-bordered table-hover " id="dataTables-example">
  <thead>
    ...
    foreach ($detail->result() as $r)
    {
        ...
        <input type='hidden' name='kode' id='kode$no' value='$head[kode]' required>     
        <input type='hidden' name='nama' id='nama3$no' value='$head[nama]' required>
        <input type='hidden' name='jenis' id='jenis3$no' value='$head[jenis]' required>    
